...
def safe_score(score: float) -> float:
    """Ensure a task score is always strictly between 0.01 and 0.99."""
...
def grade(task_id: str, findings: List[Finding], submitted: bool = False) -> Dict[str, Any]:
    """
    Deterministic grader. Returns score 0.01–0.99 with breakdown.
    ...
    conf_quality = max(conf_quality, 0.01)  # Ensure the confidence component is bounded
    ...
    score = safe_score(round(score, 4))
